...
public protocol CustomBubbleViewDataSource : class {
...
@objc protocol LynnBubbleViewDelegate : NSObjectProtocol {
    ...
    @objc optional func bubbleTableView(_ bubbleTableView:CustomBubbleTableView, didLongTouchedAt index:Int)
    @objc optional func bubbleTableView(_ bubbleTableView:CustomBubbleTableView, didTouchedUserProfile userData:CustomUserData, at index:Int)
    @objc optional func bubbleTableView(_ bubbleTableView:CustomBubbleTableView, didTouchedAttachedImage image:UIImage, at index:Int)
//    @objc optional func bubbleTableView(_ bubbleTableView:LynnBubbleTableView, didTouchedURLLink urlLink:String, at index:Int)
    @objc optional func bubbleTableView(_ bubbleTableView:CustomBubbleTableView, didSelectRowAt index:Int)
...
open class CustomBubbleTableView: UITableView {
    
    weak var bubbleDataSource:CustomBubbleViewDataSource?
    ...
    fileprivate var arrBubbleSection = [[customBubbleData]]()
...
//        self.estimatedRowHeight = 80
    ...
    override open func reloadData() {
        ...
        if numberOfRows > 0 {
            ...
            var arrBubbleDatasGroupByDay = [customBubbleData]()
            self.arrBubbleSection = [[]]
            
            let tempData:customBubbleData = datas[0]
...
extension CustomBubbleTableView : UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            let cell = tableView.dequeueReusableCell(withIdentifier: "lynnBubbleHeaderCell") as? CustomBubbleViewHeaderCell
            let bubbleData:customBubbleData = self.arrBubbleSection[indexPath.section][0]
            cell!.setDate(date: bubbleData.date, withDay:showWeekDayHeader)
            return cell!
        }
        
        let bubbleData:customBubbleData = self.arrBubbleSection[indexPath.section][indexPath.row - 1]
        ...
        if indexPath.row > 0 {
            ...
            if bubbleData.imageData != nil {
                ...
                if bubbleData.userDataType == .me {
                    ...
                    if grouping && indexPath.row > 1{
                        let previousData:customBubbleData = self.arrBubbleSection[indexPath.section][indexPath.row - 2]
...
extension CustomBubbleTableView : UITableViewDelegate
{
...
extension CustomBubbleTableView : BubbleViewCellEventDelegate {
