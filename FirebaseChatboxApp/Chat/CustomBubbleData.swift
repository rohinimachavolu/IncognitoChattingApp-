...
public class CustomAttachedImageData:NSObject {
...
public class CustomUserData :NSObject {
...
public protocol CustomAttachedImageProtocol : class {
    var imageData:CustomAttachedImageData? { set get }
    func imageUpdate(to imgView:UIImageView)
}

extension CustomAttachedImageProtocol {
    func imageUpdate(to imgView:UIImageView) {
...
public class customBubbleData: NSObject {
    
    public var userDataType:BubbleDataType = .none
    private(set) public var userData:CustomUserData = CustomUserData(userUniqueId: "")
    
    private(set) public var text:String?
    private(set) public var date:Date = Date()
    
    private(set) public var imageData: CustomAttachedImageData?
    
    convenience init(userData:CustomUserData, dataOwner type:BubbleDataType,
                     message text:String?, messageDate date:Date, attachedImage imgData:CustomAttachedImageData? = nil) {
    ...
    func isSameUser(_ data:customBubbleData) -> Bool {
